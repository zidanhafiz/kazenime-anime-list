							...
							>
								<section>
									<TableCell className='font-medium'>
										<Image
											...
											src={chara.character.images.webp.image_url ? chara.character.images.webp.image_url : defaultAvatar}
								...
								<section>
									<TableCell className='text-right'>
										<p className='font-semibold'>{chara.voice_actors[0].person.name}</p>
										<p>Japanese</p>
									</TableCell>
									<TableCell className='text-right'>
										<Image
											className='max-w-[60px]'
											src={chara.voice_actors[0] ? chara.voice_actors[0].person.images.jpg.image_url : defaultAvatar}
